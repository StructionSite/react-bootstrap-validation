...
export default class RadioGroup extends InputContainer {
  ...
  render() {
    ...
    if (this.props.label) {
      label = (
        <label
          className={classNames("control-label", this.props.labelClassName)}
        >
          {this.props.label}
        </label>
      );
...
RadioGroup.propTypes = {
  ...
  bsSize(props) {
    ...
    return PropTypes.oneOf(["small", "medium", "large"]).apply(null, arguments);
  },
  bsStyle: PropTypes.oneOf(["success", "warning", "error"]),
  groupClassName: PropTypes.string,
  wrapperClassName: PropTypes.string,
  labelClassName: PropTypes.string,
  validationEvent: PropTypes.oneOf(["onChange"]),
